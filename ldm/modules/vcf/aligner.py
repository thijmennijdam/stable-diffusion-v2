...
class ImageToTextAlignerV1(nn.Module):
    ...
    using a small feedforward network with normalization and ReLU activation (V1).
    """
...
class ImageToTextAlignerV2(nn.Module):
    """
    A neural module that projects image feature embeddings into the text embedding space
    using a small feedforward network with normalization, ReLU activation, and Dropout (V2).
    """
